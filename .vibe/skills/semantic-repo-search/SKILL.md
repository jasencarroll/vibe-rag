...
- If memory tools seem unavailable or low-quality, check whether the repo is trusted and whether a supported embedding provider is configured or reachable.
