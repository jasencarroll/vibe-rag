...
- If memory tools seem unavailable or low-quality, check whether the repo is trusted, whether Ollama is running, and whether `qwen3-embedding:0.6b` is available.
